...
MentorVision interactive dashboard (Member 5's "small app" for Deliverable 5).
The static HTML report is the shareable artifact; this is the interactive
companion a presenter can click through, clip by clip.

Run locally:
    streamlit run src/dashboard.py

Run from Colab (needs a tunnel, e.g. localtunnel) - see notebooks/05_dashboard_export.ipynb.
...
from dashboard_data import build_report_data, METRIC_COLORS
...
if data.model_card:
    ...
    st.info("Gesture model card pending — drop M4's `m4_metrics_summary.json` into the "
            "outputs/ folder to populate this section.")
